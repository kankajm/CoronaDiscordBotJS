...
function getPESData(pesNumber) {
    return __awaiter(this, void 0, void 0, function () {
        var numberToInt;
        return __generator(this, function (_a) {
            numberToInt = +pesNumber;
            return [2 /*return*/, { pesNumber: numberToInt, description: getPESDescription(numberToInt), meaning: getPESLongDescription(numberToInt), PESEmotion: getPESEmotion(numberToInt) }];
        });
    });
}
module.exports = { getPESData: getPESData };
