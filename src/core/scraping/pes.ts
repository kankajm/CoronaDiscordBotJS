function getPESDescription(pesNumber: number) {
    switch(pesNumber) {
        case 1: {
...
function getPESLongDescription(pesNumber: number) {
    switch(pesNumber) {
        case 1: {
...
function getPESEmotion(pesNumber: number) {
    switch(pesNumber) {
        case 1: {
...
async function getPESData(pesNumber: number) {
    const numberToInt: number = +pesNumber;
